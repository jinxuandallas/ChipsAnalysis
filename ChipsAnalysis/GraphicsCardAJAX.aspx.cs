...
{
    public partial class GraphicsCardAJAX : System.Web.UI.Page
    {
        protected  static business b;
        ...
        */
        ...
        [WebMethod]
        public static string Update(int id,double price)
        {
            double perform= b.UpdatePrice("Graphics", id, price);
            JavaScriptSerializer jss = new JavaScriptSerializer();

            return jss.Serialize(new { performance = perform });
